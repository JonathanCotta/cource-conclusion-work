			...
			<nav id="barra-superior" class="navbar navbar-default ">
				<div class="navbar-header">
					...
					<ul class="nav navbar-nav nav-breadcrumbs">
						...
						<li><a href="gerenciarchamado.php" class="nav-bc navbar-brand">Gerênciamento&nbsp;&nbsp;de&nbsp;&nbsp;chamados</a></li>
						<li><a href="atendimentochamado.php" class="nav-bc navbar-brand">Atendimento</a></li>
						<li><a href="" class="nav-bc-final navbar-brand">Log do chamado</a></li>
					</ul>
				</div>
			...
			<div class="panel panel-default container panel-aval">
				<nav class="navbar navbar-default">
					<div class="navbar-left">
						<h4>Log do chamado</h4>
					</div>
					<div class="navbar-right">
						<button id="voltarLog" class="btn btn-default nav-btn" rel="tooltip" title="Voltar ao chamado" data-placement="top">
							<span class="material-icons md-dark md-26">arrow_back</span>
						</button>
					</div>
				</nav>
				<table id="tabLogChamado" class="table table-condensed table-hover tableSection">
					<thead>
						<tr>
							<th>Agente</th>
							<th>Ação</th>
