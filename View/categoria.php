...
?>
	...
	<body>
			...
			<nav id="barra-superior" class="navbar navbar-default ">
				<div class="navbar-header">
					...
					<ul class="nav navbar-nav nav-breadcrumbs">
						...
						<li><a href="" class="nav-bc-final nav-brand">Categorias</a></li>
					</ul>
				</div>
		...
		<section>
			<div id="conteudo" class="panel panel-default container panel-crud">
				<h4>Gerênciamento de categorias</h4>
				...
				<table id="tabCategoria" class="table table-condensed table-hover tableSection">
					<thead>
						<tr>
							<th>Código</th>
							<th>Nome</th>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div id="modalHeader" class="modal-header">
							...
							<h4 class="modal-title"><span id="funcModal"></span>categoria</h4>
						</div>
						<div class="modal-body">
							<form action="" role="" id="formCategoria">
								<div class="row">
									<div class="form-group col-sm-4">
										<label for="nome">Nome</label>
										<input type="text" maxlength="45" name="nome" placeholder="Nome da categoria" id="nome" class="form-control" data-placement="bottom">
									</div>
									<div class="form-group col-sm-4">
										<label for="plataforma">Plataforma</label>
										<select class="form-control" id="plataformaSelect" name="plataforma">
			...
			<div id="modalEx" class="modal fade" role="dialog">
				<div class="modal-dialog">
					<div class="modal-content">
						<div id="modalHeader" class="modal-header">
							<h4 class="modal-title"><span id="funcModalEx"></span>Categoria</h4>
						</div>
						<div class="modal-body">
							<form action="" id="categoriaEx">
