	...
	<body>
			...
			<nav id="barra-superior" class="navbar navbar-default ">
				<div class="navbar-header">
					...
					<ul class="nav navbar-nav nav-breadcrumbs">
						...
						<li><a href="" class="nav-bc-final nav-brand">Cargos</a></li>
					</ul>
				</div>
		...
		<section>
			<div class="panel panel-default container panel-crud">
				...
				<table id="tabCargo" class="table table-condensed table-hover tableSection">
					<thead>
						<tr>
							<th>Código</th>
							<th>Nome</th>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div id="modalHeader" class="modal-header">
							...
							<h4 class="modal-title"><span id="funcModal"></span> cargo</h4>
						</div>
						<div class="modal-body">
							<form action="" role="" id="formCargo" name="formCargo" method="post">
								<div class="row">
									<div class="form-group col-sm-6">
										<label for="nome">Nome</label>
										<input type="text" maxlength="45" placeholder="Nome do cargo" name="nome" id="nome" class="form-control" data-placement="bottom">
									</div>
									<div class="form-group col-sm-6">
			...
			<div id="modalEx" class="modal fade" role="dialog">
				<div class="modal-dialog">
					<div class="modal-content">
						<div id="modalHeader" class="modal-header">
							<h4 class="modal-title"><span id="funcModalEx"></span>Cargo</h4>
						</div>
						<div class="modal-body">
							<form action="" id="cargoEx">
