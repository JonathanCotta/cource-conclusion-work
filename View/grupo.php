	...
	<body>
			...
			<nav id="barra-superior" class="navbar navbar-default ">
				<div class="navbar-header">
					...
					<ul class="nav navbar-nav nav-breadcrumbs">
						...
						<li><a href="" class="nav-bc nav-brand">Grupos&nbsp;e&nbsp;atendentes</a></li>
						<li><a href="" class="nav-bc-final nav-brand">Grupos</a></li>
					</ul>
				</div>
		...
		<section>
			<div class="panel panel-default container panel-crud">
				...
				<table id="tabGrupo" class="table table-condensed table-hover tableSection">
					<thead>
						<tr>
							<th>Código</th>
							<th>Nome</th>
				...
				<div class="modal-dialog modalManejameto">
					<div class="modal-content">
						<div id="modalHeader" class="modal-header">
							...
							<h4 class="modal-title"><span id="funcModal"></span>grupo</h4>
						</div>
						<div class="modal-body">
							<form action="" role="" id="formGrupo">
								<div class="row">
									<div class="form-group col-sm-12">
										<label for="nome">Nome</label>
										<input type="text" maxlength="45" placeholder="Nome do grupo" id="nome" name="nome" class="form-control">
									</div>
								</div>
			...
			<div id="modalEx" class="modal fade" role="dialog">
				<div class="modal-dialog ">
					<div class="modal-content">
						<div id="modalHeader" class="modal-header">
							<h4 class="modal-title"><span id="funcModalEx"></span>Grupo</h4>
						</div>
						<div class="modal-body">
							<form action="" id="grupoEx">
