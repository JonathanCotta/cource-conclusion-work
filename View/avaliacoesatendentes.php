...
?>
	...
	<head>
		<meta charset="utf-8">
		<title>AvaliçõesDeAtendentes</title>
	...
	<body>
			...
			<nav id="barra-superior" class="navbar navbar-default ">
				<div class="navbar-header">
					...
					<ul class="nav navbar-nav nav-breadcrumbs ">
						...
						<li><a href="" class="nav-bc-final navbar-brand">Avaliações de atendentes</a></li>
					</ul>
				</div>
		...
		<section>
			<div class="panel panel-default container panel-crud">
				<h4>Avaliações por atendentes</h4>
				...
				<table id="tabAvalAtendente" class="table table-condensed table-hover tableSection">
					<thead>
						<tr>
							<th>Nome</th>
