...
?>
	...
	<head>
		<meta charset="utf-8">
		<title>ManejamentoDeAtendentes</title>
	...
	<body>
			...
			<nav id="barra-superior" class="navbar navbar-default ">
				<div class="navbar-header">
					...
					<ul class="nav navbar-nav nav-breadcrumbs ">
						...
						<li><a href="" class="nav-bc navbar-brand">Grupos&nbsp;e&nbsp;Atendentes</a></li>
						<li><a href="" class="nav-bc-final navbar-brand">Manejamento de atendentes</a></li>
					</ul>
		...
		<section>
			<div class="panel panel-default container panel-crud">
				<h4>Manejamento de atendentes</h4>
				<nav class="navbar navbar-default">
					<div class="row">
						<form class="navbar-form navbar-left" role="search" id="formPesquisa">
							...
							<div class="form-group input-group selectGrupo">
						...
						<div class="navbar-right">
							<button id="inserir" class="btn btn-default nav-btn nv-1" rel="tooltip" title="Adicionar atendente ao grupo" data-placement="left">
								<span class="material-icons md-dark md-26">add_circle</span>
							</button>
							<button id="reativarAtendente" class="btn btn-default nav-btn nv-1" rel="tooltip" title="Reativar atendentes do grupo" data-placement="top">
								<span class="material-icons md-dark md-26">replay</span>
							</button>
							<button id="excluir" class="btn btn-default nav-btn nv-1" rel="tooltip" title="Remover atendente do grupo" data-placement="right">
								<span class="material-icons md-dark md-26">delete</span>
							</button>
						</div>
					</div>
				</nav>
				<table id="tabManejaGrupo" class="table table-condensed table-hover tableSection">
					<thead>
						<tr>
							<th>Código</th>
							<th>Nome</th>
				...
				<div class="modal-dialog modalManejameto ">
					<div class="modal-content ">
						<div id="modalHeader" class="modal-header">
							...
							<h4 class="modal-title">Adicionar atendente ao grupo</h4>
						</div>
						<div class="modal-body">
							<form action="" role="" id="formManejaGrupo">

								<div class="row">
									<div class="form-group col-sm-12">
										<label for="atendente">Atendente</label>
										<select class="form-control" id="atendenteSelect" name="atendente" required>
			...
			<div id="modalReativar" class="modal fade " role="dialog">
				<div class="modal-dialog modalManejameto ">
					<div class="modal-content ">
						<div id="modalHeader" class="modal-header">
							<button type="button" class="close" data-dismiss="modal">&times;</button>
							<h4 class="modal-title">Reativar atendentes</h4>
						</div>
						<div class="modal-body">
							<form action="" role="" id="formManejaGrupo">
								...
								<div class="row">
									<div class="form-group col-sm-12">
										<label for="atendente">Atendente</label>
										<select class="form-control" id="atendenteInativoSelect" name="atendente" required>
						...
						<div id="modalFooter" class="modal-footer">
							<button type="button" id="reativarModal" class="btn btn-info">Reativar</button>
							<button type="reset" class="btn btn-default" data-dismiss="modal">Voltar</button>
						</div>
						</form>
					</div>
			...
			<div id="modalEx" class="modal fade" role="dialog">
				<div class="modal-dialog">
					<div class="modal-content">
						<div id="modalHeader" class="modal-header">
							<h4 class="modal-title"><span id="funcModalEx"></span>Atendente</h4>
						</div>
						<div class="modal-body">
							<form action="" id="manejaGrupoEx">
								<h4>Deseja mesmo remover este atendente do grupo ?</h4>
						</div>
						<div id="modalFooter" class="modal-footer">
