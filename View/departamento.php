	...
	<body>
		...
		<section>
			<div class="panel panel-default container panel-crud">
				<h4>Gerênciamento de departamentos</h4>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div id="modalHeader" class="modal-header">
							...
							<h4 class="modal-title"><span id="funcModal"></span> departamento</h4>
						</div>
						<div class="modal-body">
							<form action="" role="" id="formDepartamento">
								<div class="row">
									<div class="form-group col-sm-6">
										<label for="nome">Nome</label>
										<input type="text" maxlength="45" name="nome" placeholder="Nome do departamento" id="nome" class="form-control" data-placement="bottom">
									</div>
									<div class="form-group col-sm-6">
			...
			<div id="modalEx" class="modal fade" role="dialog">
				<div class="modal-dialog">
					<div class="modal-content">
						<div id="modalHeader" class="modal-header">
							<h4 class="modal-title"><span id="funcModalEx"></span>Departamento</h4>
						</div>
						<div class="modal-body">
							<form action="" id="departamentoEx">
